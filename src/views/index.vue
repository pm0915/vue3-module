<template>
  <div class="dark:text-slate-400 dark:bg-slate-900">
    <main class="max-w-5xl px-4 mx-auto sm:px-6 md:px-8 xl:px-12 xl:max-w-6xl">
      <div class="pt-8 pb-7 sm:pb-8 sm:text-center">
        ...
        <p class="text-2xl text-slate-800 dark:text-slate-400">最新Vue3技术流，超全配置，大厂协作规范</p>
      </div>
    </main>
    <article class="space-y-20 sm:space-y-32 md:space-y-40 lg:space-y-44">
      <ul class="flex flex-wrap items-center justify-center sm:px-10 lg:px-15 xl:px-15 sm:justify-center lg:justify-around">
